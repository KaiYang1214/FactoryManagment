...
import { ETLNodeFactory } from '../ETLNode/ETLNodeFactory';
import { ETLNodeModel } from '../ETLNode/ETLNodeModel';
import { TableNodeFactory } from '../TableNode/TableNodeFactory';
import { TableNodeModel } from '../TableNode/TableNodeModel';
import { OutputNodeFactory } from '../OutputNode/OutputNodeFactory';
import { OutputNodeModel } from '../OutputNode/OutputNodeModel';
import { OutputSettingNodeFactory } from '../OutputSettingNode/OutputSettingNodeFactory';
import { OutputSettingNodeModel } from '../OutputSettingNode/OutputSettingNodeModel';
import { LinkNodeFactory } from '../LinkNode/LinkNodeFactory';
import { JoinNodeFactory } from '../JoinNode/JoinNodeFactory';
import { JoinNodeModel } from '../JoinNode/JoinNodeModel';
import { WhereNodeFactory } from '../WhereNode/WhereNodeFactory';
import { WhereNodeModel } from '../WhereNode/WhereNodeModel';
import { CalculateNodeFactory } from '../CalculateNode/CalculateNodeFactory';
import { CalculateNodeModel } from '../CalculateNode/CalculateNodeModel';
import { GroupNodeFactory } from '../GroupNode/GroupNodeFactory';
import { GroupNodeModel } from '../GroupNode/GroupNodeModel';
import { ETLPortFactory } from '../ETLPort/ETLPortFactory';
import TrayItemWidget from '../TrayItemWidget/TrayItemWidget';
import TrayItemGroupWidget from '../TrayItemGroupWidget/TrayItemGroupWidget';
...
const SqlDiagram = ({
  ...
  const addNode = (data = {}, nodeModel) => {
    return add(data, nodeModel || MODEL_MAP[data.key]);
  };
  ...
  return (
    <Style.sqlDiagram className={disabled ? 'disabled' : ''} id="sqldiagram">
